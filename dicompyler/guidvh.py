...
class guiDVH:
    ...
    def __init__(self, parent):
        ...
        self.panelDVH = wxmpl.PlotPanel(
            parent, -1, size=(6, 4.50), dpi=68, crosshairs=False, autoscaleUnzoom=False
        )
        self.Replot()
    ...
    def DrawDVH(
        ...
        axes.plot(dose, dvh, label=name, color=color, linewidth=2, linestyle=linestyle)
